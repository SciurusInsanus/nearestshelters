...
Может быть, вы найдете возможность самостоятельно доставить то, что отдаете, в ближайший к вам приют, расположенный в районе ${nearest[0].district}? Возможно, кто-то из ваших родственников или знакомых сможет вам помочь в этом?
...
Приют, куда вы можете передать помощь, находится в районе ${nearest[0].district}. 
Контакт волонтера приюта, с которым можно будет обсудить передачу помощи: ${nearest[0].phone}, ${nearest[0].volunteer}.
Не затруднит ли вас связаться с волонтером самостоятельно, чтобы согласовать все детали напрямую? Когда будете звонить, можно сказать, что контакт дали в фонде «РЭЙ».
